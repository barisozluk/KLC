            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim veritabanından silinemedi. - " + exception.InnerException.Message);
                        }
                        else
                        {
                            log.Error("Uç birim veritabanından silinemedi. - " + exception.Message);
                        }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim türü veritabanına kaydedilemedi. - " + exception.Message);
                        }
                        transaction.Rollback();
                    }
                }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim veritabanına kaydedilemedi. - " + exception.Message);
                        }
                        transaction.Rollback();
                    }
                }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    try
                    {
                        ...
                        {
                            var list = context.UcBirimAgArayuzu
                                .Include(x => x.AgArayuzu)
                                .Where(aa => aa.UcBirimId == ucBirim.Id).ToList();
                        ...
                        {
                            var list = context.UcBirimGucArayuzu
                                            .Include(x => x.GucArayuzu)
                                            .Where(ga => ga.UcBirimId == ucBirim.Id).ToList();
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim veritabanında güncellenemedi. - " + exception.Message);
                        }
                        transaction.Rollback();
                    }
                }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim türleri veritabanından getirilemedi. - " + exception.Message);
                        }
                    }
                }
            }
        ...
        public List<UcBirim> ListUcBirim()
        {
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    try
                    {
                        response = context.UcBirim.Include(x => x.UcBirimTur).ToList();
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birimler veritabanından getirilemedi. - " + exception.Message);
                        }
                    }
                }
            }
                ...
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    try
                    {
                        response = context.UcBirimAgArayuzu
                                                .Include(x => x.UcBirim).ThenInclude(x => x.UcBirimTur)
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim ağ arayüzleri veritabanından getirilemedi. - " + exception.Message);
                        }
                    }
                }
            }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim güç arayüzleri veritabanından getirilemedi. - " + exception.Message);
                        }
                    }
                }
            }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim veritabanından getirilemedi. - " + exception.Message);
                        }
                    }
                }
            }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim türü veritabanından getirilemedi. - " + exception.Message);
                        }
                    }
                }
            }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim toplu güncelleme işlemi gerçekleştirilemedi. - " + exception.Message);
                        }
                        transaction.Rollback();
                    }
                }
            ...
            using (AYPContext context = new AYPContext())
            {
                using (var transaction = context.Database.BeginTransaction(IsolationLevel.ReadUncommitted))
                {
                    try
                    {
                        ...
                        {
                            UcBirim ucBirimItem = context.UcBirim.Include(x => x.UcBirimTur).Where(ub => ub.StokNo == ucBirim.StokNo).FirstOrDefault();
                    ...
                    catch (Exception exception)
                    {
                        ...
                        {
                            log.Error("Uç birim kütüphanesi veritabanına aktarılamadı. - " + exception.Message);
                        }
                    }
                }
            }
